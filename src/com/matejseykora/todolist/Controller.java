package com.matejseykora.todolist;

import com.matejseykora.todolist.datamodel.TodoData;
import com.matejseykora.todolist.datamodel.TodoItem;
...
public class Controller {
    ...
    public void deleteItem(TodoItem item) {
        Alert alert = new Alert(Alert.AlertType.CONFIRMATION); // buttons are added automatically based on the provided type
    ...
    // handle button based on the code in a constructor
    @FXML
    public void handleFilterButton() {
        ...
        if (filterToggleButton.isSelected()) {
            ...
            todoListView.getSelectionModel().select(selectedItem); // select item when turning a filter off
        }
    }
